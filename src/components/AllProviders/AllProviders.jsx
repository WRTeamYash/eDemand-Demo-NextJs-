        ...
        <div className="commanSec mt-12 flex flex-col items-start justify-center gap-6 w-full container mx-auto">
          <div className="Headlines flex flex-col w-full">
            ...
            <span className="description_color">
              {providers.length} {t("of")} {total} {t("providers")}
            </span>
          </div>

          {/* Search and Sort */}
          <div className="filterSec flex flex-wrap lg:flex-nowrap items-center justify-between mt-4 gap-4 w-full">
            {/* Search Input */}
            <div className="flex items-center justify-between gap-2 px-4 py-2 border rounded-md description_color flex-grow">
              ...
              <div>
                <button
                  onClick={handleSerch}
                  className="transition-all duration-300 border hover:border_color px-4 py-2 background_color hover:primary_bg_color description_color hover:text-white rounded-lg"
                >
                  {t("search")}
                </button>
              </div>
