...
import { addServiceReviewApi } from "@/api/apiRoutes";
...
const BookingDetails = () => {
  ...
  const priceBreakdown = [
    { label: t("subTotal"), amount: bookingData?.total },
    {
  ...
  const handleRateService = (serviceId, existingReview = null) => {
            ...
            <div className="col-span-12 lg:col-span-9">
              <div className="flex flex-col gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <div className="page-headline text-3xl font-semibold">
                ...
                <div className="grid grid-cols-1 gap-6">
                  <main className="w-full space-y-6">
                          ...
                          {bookingData?.status !== "completed" && (
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                onClick={() => handleCopyOtp(bookingData?.otp)}
                              >
                                {bookingData?.otp}
                              </button>
                            </div>
                            ...
                            bookingData?.status === "completed" && (
                              <>
                                <button
                                  ...
                                  onClick={() => handleReOrder(bookingData.id)}
                                >
                                  {t("reOrder")}
                                </button>
                              </>
                    ...
                    {bookingData?.services?.length > 0 && (
                      <>
                        <section className="space-y-4">
                          <h2 className="description_color">{t("services")}</h2>
                        ...
                        <div className="flex flex-col gap-2 w-full">
                          ...
                          <div className="flex flex-wrap items-center gap-3 w-full">
                            {paymentModes.map((paymentMode) => {
                              if (paymentMode.method === bookingData?.payment_method) {
                                return (
                                  <div
                        ...
                        <div className="flex flex-col gap-2 w-full">
                          ...
                          <div className="flex flex-wrap items-center gap-3 w-full">
                            {["success", "pending", "failed"].includes(
                              ...
                              <div
                                className={`flex items-center gap-3 p-3 text-sm md:text-base rounded-[4px] ${
                                  getPaymentStatusUI(
                                    bookingData?.payment_status || "pending"
                                  )?.bgClass
                                }`}
                            ...
                            {bookingData?.work_started_proof?.map(
                              (img, index) => (
                                <div
                                  className="photo cursor-pointer"
                                  key={index}
                                  onClick={() => openLightboxStartedWork(index)}
                                >
                                  <CustomImageTag
                                    width={0}
                                    height={0}
                    ...
                    <Card className="light_bg_color border-color">
                      <CardContent className="space-y-6 p-4">
                            ...
                            <div className="flex justify-between items-center">
                              <div className="flex items-center gap-2">
                                ...
                                {item.subCharges?.length > 0 && (
                                  ...
                                  >
                                    <FaChevronDown
                                      className={`transition-transform duration-200 ease -in -out primary_text_color ${
                        ...
                        <div className="flex justify-between font-bold text-lg">
                          ...
                          <span className="primary_text_color">
                            {showPrice(bookingData?.final_total)}
                          </span>
                        </div>
                      </CardContent>
                    </Card>
